...
namespace VTORRES_PruebaProgreso1.Controllers
{
    public class CelularsController : Controller
    {
        ...
        public CelularsController(VTORRES_PruebaProgreso1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Modelo,year,Precio")] Celular celular)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Modelo,year,Precio")] Celular celular)
        {
            if (id != celular.Id)
            {
                return NotFound();
